...
#define LT_SPC LT(LAYER_CONTROL, KC_SPC)
#define MO_QANT MO(LAYER_QUANTUM)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_QUANTUM] = LAYOUT_60_ansi(
        QK_BOOT, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9780-,   KC_F10,  KC_F11,  KC_F12,  _______,
